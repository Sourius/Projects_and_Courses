...
?&gt;
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/02_Variables" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/04_DefiningConstants" class="button next">Next Lecture</a>
			</div><!-- end navs -->
