...
?&gt;
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/23_Functions" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/25_SimpleArguments" class="button next">Next Lecture</a>
			</div><!-- end navs -->
