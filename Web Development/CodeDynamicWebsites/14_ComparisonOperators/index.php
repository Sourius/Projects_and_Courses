...
if ($yearsOnEarth <= 25) {
	...
	echo "Your age is less than or equal to 25!";
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/13_GetYourHandsDirty" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/15_LogicalOperators" class="button next">Next Lecture</a>
			</div><!-- end navs -->
