...
?&gt;
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/17_StringOperators" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/19_WhileLoop" class="button next">Next Lecture</a>
			</div><!-- end navs -->
