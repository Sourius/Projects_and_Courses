...
for ($a = 0; $a <= 20; $a++) {
	...
	echo "Number: $a <br>";
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/19_WhileLoop" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/21_ForeachLoop" class="button next">Next Lecture</a>
			</div><!-- end navs -->
