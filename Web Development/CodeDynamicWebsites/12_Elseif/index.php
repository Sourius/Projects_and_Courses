...
?&gt;
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/11_Else" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/13_GetYourHandsDirty" class="button next">Next Lecture</a>
			</div><!-- end navs -->
