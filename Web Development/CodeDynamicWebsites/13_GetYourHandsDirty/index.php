...
<html>
	...
	<body>
		<div class="wrapper">
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/12_Elseif" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/14_ComparisonOperators" class="button next">Next Lecture</a>
			</div><!-- end navs -->
