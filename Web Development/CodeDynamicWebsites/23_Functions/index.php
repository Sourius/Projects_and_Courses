...
foreach ($dinner as $ingredient) {
    echo "$ingredient <br>";
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/22_DoWhileLoop" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/24_CustomFunctions" class="button next">Next Lecture</a>
			</div><!-- end navs -->
