...
while ( $i <= 10 );
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/21_ForeachLoop" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/23_Functions" class="button next">Next Lecture</a>
			</div><!-- end navs -->
