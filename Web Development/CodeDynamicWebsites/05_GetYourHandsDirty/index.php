...
<html>
	...
	<body>
		<div class="wrapper">
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/04_DefiningConstants" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/06_Arrays" class="button next">Next Lecture</a>
			</div><!-- end navs -->
