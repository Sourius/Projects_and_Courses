...
<html>
	...
	<body>
		<div class="wrapper">
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/08_MultiDimensionalArrays" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/10_IfStatements" class="button next">Next Lecture</a>
			</div><!-- end navs -->
