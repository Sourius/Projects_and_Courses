...
&lt;?php echo $handlebar["creep_factor"]; ?&gt;
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/06_Arrays" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/08_MultiDimensionalArrays" class="button next">Next Lecture</a>
			</div><!-- end navs -->
