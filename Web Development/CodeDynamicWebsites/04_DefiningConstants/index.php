...
&lt;?php echo TITLE; ?&gt;
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/03_MoreVariables" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/05_GetYourHandsDirty" class="button next">Next Lecture</a>
			</div><!-- end navs -->
