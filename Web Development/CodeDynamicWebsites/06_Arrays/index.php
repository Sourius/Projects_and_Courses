...
?&gt;
			...
			<div class="navs cf">
				...
				<?php if (isset($ref) and $ref) { ?>
				
				<a href="/<?php echo $ref; ?>" class="button prev">Back to Foreach Loop</a>
				
				<?php } else { ?>
				
				<a href="/CodeDynamicWebsites/05_GetYourHandsDirty" class="button prev">Previous Lecture</a>
				
				<?php } ?>
				
				<a href="/CodeDynamicWebsites/07_AssociativeArrays" class="button next">Next Lecture</a>
			</div><!-- end navs -->
