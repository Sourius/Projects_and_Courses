...
<html>
	...
	<body>
		<div class="wrapper">
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/07_AssociativeArrays" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/09_GetYourHandsDirty" class="button next">Next Lecture</a>
			</div><!-- end navs -->
