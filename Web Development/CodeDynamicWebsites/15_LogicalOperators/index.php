...
if ($username == 'johnnyboy' && $password == 'qwerty') {
	...
	echo "Your username and password combination are incorrect";
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/14_ComparisonOperators" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/16_ArithmeticOperators" class="button next">Next Lecture</a>
			</div><!-- end navs -->
