...
?&gt;
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/18_AssignmentOperators" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/20_ForLoop" class="button next">Next Lecture</a>
			</div><!-- end navs -->
