...
echo $a; // This prints "Hola Mi Amigos!"
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/16_ArithmeticOperators" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/18_AssignmentOperators" class="button next">Next Lecture</a>
			</div><!-- end navs -->
